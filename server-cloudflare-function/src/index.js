...
const STATIC_DATA = {
  ...
  services: [
    ...
    { id: 11, categoryId: 1, name: "Velvet jelly tint", nameEn: "Velvet Jelly Tint", nameVi: "Velvet jelly tint", description: "Sơn jelly trong veo, phủ top velvet và massage tinh dầu nhẹ.", descriptionEn: "Glossy jelly tint, velvet top coat, and a light aromatherapy massage.", descriptionVi: "Sơn jelly trong veo, phủ top velvet và massage tinh dầu nhẹ.", durationMinutes: 50, price: 3600, badge: "Trend mới", badgeEn: "Fresh drop", badgeVi: "Trend mới", accent: "rose", tagline: "Hiệu ứng syrup bóng trong", taglineEn: "Glassy syrup finish", taglineVi: "Hiệu ứng syrup bóng trong" },
    { id: 12, categoryId: 2, name: "Bare satin manicure", nameEn: "Bare Satin Manicure", nameVi: "Bare satin manicure", description: "Dũa form, chăm cuticle kỹ và phủ màu nude satin mịn.", descriptionEn: "Shape, detailed cuticle care, and a smooth satin nude finish.", descriptionVi: "Dũa form, chăm cuticle kỹ và phủ màu nude satin mịn.", durationMinutes: 35, price: 2200, badge: null, badgeEn: null, badgeVi: null, accent: "sand", tagline: "Tối giản nhưng rất sạch tay", taglineEn: "Minimal and polished", taglineVi: "Tối giản nhưng rất sạch tay" },
    { id: 13, categoryId: 3, name: "Chrome mirror set", nameEn: "Chrome Mirror Set", nameVi: "Chrome mirror set", description: "Hiệu ứng chrome gương, nền sữa và line bạc nổi bật.", descriptionEn: "Mirror chrome finish with a milky base and silver detailing.", descriptionVi: "Hiệu ứng chrome gương, nền sữa và line bạc nổi bật.", durationMinutes: 70, price: 5200, badge: "Nổi bật", badgeEn: "Spotlight", badgeVi: "Nổi bật", accent: "cobalt", tagline: "Bắt sáng mạnh cho ảnh flash", taglineEn: "Made for flash photos", taglineVi: "Bắt sáng mạnh cho ảnh flash" },
    { id: 14, categoryId: 3, name: "Aura airbrush blend", nameEn: "Aura Airbrush Blend", nameVi: "Aura airbrush blend", description: "Chuyển màu aura airbrush, line mảnh và lớp gel bồng nhẹ.", descriptionEn: "Aura airbrush blending with delicate linework and soft gel volume.", descriptionVi: "Chuyển màu aura airbrush, line mảnh và lớp gel bồng nhẹ.", durationMinutes: 80, price: 6100, badge: "Mới", badgeEn: "New", badgeVi: "Mới", accent: "violet", tagline: "Bảng màu đang viral tuần này", taglineEn: "The color blend trending this week", taglineVi: "Bảng màu đang viral tuần này" },
    { id: 15, categoryId: 4, name: "Detox pedicure therapy", nameEn: "Detox Pedicure Therapy", nameVi: "Detox pedicure therapy", description: "Ngâm thảo mộc, đá nóng mini và serum phục hồi gót chân.", descriptionEn: "Herbal soak, mini hot stone massage, and heel recovery serum.", descriptionVi: "Ngâm thảo mộc, đá nóng mini và serum phục hồi gót chân.", durationMinutes: 75, price: 5600, badge: "Phục hồi", badgeEn: "Recovery", badgeVi: "Phục hồi", accent: "emerald", tagline: "Hợp chân khô và đi lại nhiều", taglineEn: "Ideal after long days on your feet", taglineVi: "Hợp chân khô và đi lại nhiều" },
    { id: 16, categoryId: 5, name: "Collagen hand & foot ritual", nameEn: "Collagen Hand & Foot Ritual", nameVi: "Collagen hand & foot ritual", description: "Ủ collagen tay chân, massage bấm huyệt và khóa ẩm bằng paraffin.", descriptionEn: "Collagen wrap for hands and feet, pressure-point massage, and paraffin seal.", descriptionVi: "Ủ collagen tay chân, massage bấm huyệt và khóa ẩm bằng paraffin.", durationMinutes: 55, price: 4300, badge: "Spa", badgeEn: "Spa", badgeVi: "Spa", accent: "gold", tagline: "Một lượt dưỡng trọn tay lẫn chân", taglineEn: "One session for hands and feet", taglineVi: "Một lượt dưỡng trọn tay lẫn chân" },
  ],
};
